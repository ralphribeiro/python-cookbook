...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','plyexample.py',47),
  ('expr -> expr MINUS term','expr',3,'p_expr','plyexample.py',48),
  ('expr -> term','expr',1,'p_expr_term','plyexample.py',58),
  ('term -> term TIMES factor','term',3,'p_term','plyexample.py',65),
  ('term -> term DIVIDE factor','term',3,'p_term','plyexample.py',66),
  ('term -> factor','term',1,'p_term_factor','plyexample.py',76),
  ('factor -> NUM','factor',1,'p_factor','plyexample.py',83),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','plyexample.py',90),
]
